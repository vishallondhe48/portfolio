            ...
            <div className="about container" id='about'>
                ...
                <div className="about-section">
                    ...
                    <div className="text-section box">
                        ...
                        <a href="https://drive.google.com/file/d/1WL3qnPhbmijlU0QuYdFRcrXS5W0dlqIC/view?usp=share_link" target="_blank" rel="noopener noreferrer" className='cta'>Download Resume</a>
